...
namespace TenPay 
{
    public class JsApiPayMvc
    {
        ...
        */
         ...
         * @失败时抛异常WxPayException
         */
        public WxPayData GetUnifiedOrderResult(string body = "test", string attach= "test", string goods_tag= "test")
        {
            //统一下单
            WxPayData data = new WxPayData();
            data.SetValue("body", body);
            data.SetValue("attach", attach);
            data.SetValue("out_trade_no", TenPay.GenerateOutTradeNo());
            ...
            WxPayData result = TenPay.UnifiedOrder(data);
        ...
        */
        public string GetEditAddressParameters()
        {
            ...
            try
            {
                ...
                signData.SetValue("noncestr", TenPay.GenerateNonceStr());
