    ...
    public class NativePay
    {
        ...
        */
        public string GetPrePayUrl(string productId)
        {
            ...
            data.SetValue("time_stamp", TenPay.GenerateTimeStamp());//时间戳
            data.SetValue("nonce_str", TenPay.GenerateNonceStr());//随机字符串
        ...
        */
        public string GetPayUrl(string productId)
        {
            ...
            data.SetValue("out_trade_no", TenPay.GenerateOutTradeNo());//随机字符串
            ...
            WxPayData result = TenPay.UnifiedOrder(data);//调用统一下单接口
